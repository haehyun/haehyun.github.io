...
% Students advised, co-advised, or mentored are underlined and conference acceptance rates are provided when available.
    ...
    \begin{enumerate}[leftmargin=0pt]
		...
		% \item Marzieh Bitaab, \textbf{Haehyun Cho}, Adam Oest, Zhuoer Lyu, Rana Pourmohamad, Jorij Abraham, Ruoyu Wang, Tiffany Bao, Yan Shoshitaishvili, and Adam Doup\'e.
		% ``Beyond Phish: Toward Detecting Scam Websites at Scale,'' 
		% \emph{in Proceedings of the 31st USENIX Security Symposium} \textbf{(SEC)},
		% Boston, MA, Aug 2022.

		% \item Penghui Zhang, Zhibo Sun, Zhuoer Lyu, \textbf{Haehyun Cho}, Adam Oest, Tiffany Bao, Ruoyu Wang, Yan Shoshitaishvili, and Adam Doup\'e.
		% ``PhishPath: Understanding the Scaly Underbelly of Redirection Chains in Phishing,'' 
		% \emph{in Proceedings of the 31st USENIX Security Symposium} \textbf{(SEC)},
		% Boston, MA, Aug 2022.
    ...
    \begin{enumerate}[leftmargin=0pt]
		...
		\item Penghui Zhang, Adam Oest, \textbf{Haehyun Cho}, Zhibo Sun, RC Johnson, Brad Wardman, Shaown Sarker, Alexandros Kapravelos, Tiffany Bao, Ruoyu Wang, Yan Shoshitaishvili, Adam Doup\'e, and Gail-Joon Ahn,
		``CrawlPhish: Large-Scale Analysis of Client-Side Cloaking Techniques in Phishing,''
		\emph{IEEE Security \& Privacy}, Volume 20, pp. 10-21, Apr 2022. 
		...
		\emph{IEEE Access}, Volume 10, pp. 20008-20018, Feb 2022.
		...
		\emph{International Journal of Information Security}, Feb 2022.
		...
		\emph{IEEE Access}, Volume 9, pp. 119578-119590, Aug 2021.
